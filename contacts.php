		...
		<header>
			...
			<nav>
				<ul>
					...
					<li><a href="orar.php">Orarul</a></li>
					<li><a href="gallery.php">Galerie</a></li>
					<li><a id="current" href="contacts.php">Contacte</a></li>
				</ul>
			</nav>
		</header>
	</div>
		...
		<div id="goomap">
			...
			<script>
				...
				function init() {
					...
					var locations = [ [ 'ARINTUR-TRANS',
							'Bălți, str. Independentii 70/6', '+37369265880',
							'arinturtrans@mail.ru', 'undefined', 47.754415,
							27.918481,
					...
					for (i = 0; i < locations.length; i++) {
						...
						bindInfoWindow(marker, map, locations[i][0],
								description, telephone, email, web, link);
					}
